defmodule CesiumCupWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CesiumCupWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/cesium_cup_web/templates",
        namespace: CesiumCupWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {CesiumCupWeb.LayoutView, "live.html"}
